...
class RPCService extends events_1.EventEmitter {
    ...
    accountVerify(req) {
        return new Promise((resolve, reject) => {
            ...
            this.service().accountVerify(req, (err, resp) => {
                if (err) {
                    reject(err);
                    this.emitError(err);
                    return;
    ...
    orgKey(req) {
        return new Promise((resolve, reject) => {
            ...
            this.service().orgKey(req, (err, resp) => {
                if (err) {
                    reject(err);
                    this.emitError(err);
                    return;
    ...
    orgCreate(req) {
        return new Promise((resolve, reject) => {
            ...
            this.service().orgCreate(req, (err, resp) => {
                if (err) {
                    reject(err);
                    this.emitError(err);
                    return;
    ...
    orgSign(req) {
        return new Promise((resolve, reject) => {
            ...
            this.service().orgSign(req, (err, resp) => {
                if (err) {
                    reject(err);
                    this.emitError(err);
                    return;
    ...
    orgInvites(req) {
        return new Promise((resolve, reject) => {
            ...
            this.service().orgInvites(req, (err, resp) => {
                if (err) {
                    reject(err);
                    this.emitError(err);
                    return;
    ...
    orgInviteAccept(req) {
        return new Promise((resolve, reject) => {
            ...
            this.service().orgInviteAccept(req, (err, resp) => {
                if (err) {
                    reject(err);
                    this.emitError(err);
                    return;
