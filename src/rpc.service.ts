...
export class RPCService extends EventEmitter {
  ...
  authStatus(req: service.AuthStatusRequest): Promise<service.AuthStatusResponse> {
    return new Promise<service.AuthStatusResponse>((resolve, reject) => {
      this.log.info('authStatus')
      this.service().authStatus(req, (err: RPCError, resp: service.AuthStatusResponse) => {
        if (err) {
          reject(err)
          this.emitError(err)
          return
  ...
  accountRegister(req: service.AccountRegisterRequest): Promise<service.AccountRegisterResponse> {
    return new Promise<service.AccountRegisterResponse>((resolve, reject) => {
      this.log.info('accountRegister')
      this.service().accountRegister(req, (err: RPCError, resp: service.AccountRegisterResponse) => {
        if (err) {
          reject(err)
          this.emitError(err)
          return
  ...
  accountSetUsername(req: service.AccountSetUsernameRequest): Promise<service.AccountSetUsernameResponse> {
    return new Promise<service.AccountSetUsernameResponse>((resolve, reject) => {
      this.log.info('accountSetUsername')
      this.service().accountSetUsername(req, (err: RPCError, resp: service.AccountSetUsernameResponse) => {
        if (err) {
          reject(err)
          this.emitError(err)
          return
  ...
  teamInvites(req: service.TeamInvitesRequest): Promise<service.TeamInvitesResponse> {
    return new Promise<service.TeamInvitesResponse>((resolve, reject) => {
      this.log.info('teamInvites')
      this.service().teamInvites(req, (err: RPCError, resp: service.TeamInvitesResponse) => {
        if (err) {
          reject(err)
          this.emitError(err)
          return
